...
public class SoggettoController : ControllerBase
{
    ...
    {
        await _business.CreateSoggettoAsync(soggettoDto);
    ...
    {
        var soggetto = await _business.ReadSoggettoAsync(idAnagrafica);
    ...
    {
        return await _business.GetFromDemograficoAsync(codiceFiscale);
    }
}
